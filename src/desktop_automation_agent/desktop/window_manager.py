...
class Win32WindowBackend:
    def enumerate_windows(self) -> list[WindowContext]:
        ...
        try:
            ...
            logger.warning("user32.dll not available for window enumeration.")
            return []
        ...
        def callback(hwnd: int, lparam: int) -> bool:
            try:
                ...
                logger.warning("Error during window enumeration callback: %s", e)
            return True
    ...
    def get_window_by_handle(self, handle: int) -> WindowContext | None:
        ...
        try:
            ...
            logger.warning("Failed to get window by handle %s: %s", handle, e)
            return None

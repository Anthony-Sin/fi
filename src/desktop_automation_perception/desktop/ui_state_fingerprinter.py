...
from desktop_automation_perception.contracts import ScreenCaptureBackend, UILandmarkProvider, WindowManager
from desktop_automation_perception.models import UIStateFingerprint, UILandmark
